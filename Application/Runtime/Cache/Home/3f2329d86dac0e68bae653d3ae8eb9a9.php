...
<form method="post" action="/index.php/Home/admin/doupdate">
<div style="width:1000px;  height:300px ;margin-left: 100px">
    <?php if(is_array($detail)): $i = 0; $__LIST__ = $detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="float:left ;  width:50%;  height:100%;text-align: center">
            <div id="<?php echo ($vo["id"]); ?>" style="width: 200px;margin-left: 200px;margin-top: 30px">
                <input type="hidden" value="<?php echo ($vo["id"]); ?>" id="movie_id" name="id">
        ...
        <div  style="float:left ;  width:50%; height:100%;margin-top: 30px">
            ...
            <div id="info">
                <div>
                    <h1>
                        <input value="<?php echo ($vo["title"]); ?>" name="title">
                    </h1>
                    <div >
                    <span class="p1">
                        导演:
                        <span class="attrs">
                             <input class="attrs" value=" <?php echo ($vo["director"]); ?>" name="director" style="width: 250px">
                        </span>
                    </span>
                        ...
                        <span class="attrs">
                            <input class="attrs" value="<?php echo ($vo["actor"]); ?>" name="actor" style="width: 250px">
                        </span>
                    </span>
                        <br/>
                        <span class="p1">
                        类型:
                        <span class="attrs">
                            <input class="attrs" value=" <?php echo ($vo["style"]); ?>" name="style" style="width: 250px">
                        </span>
                    </span>
                        <br/>
                        <span class="p1">
                        国家:
                        <input class="attrs" value="<?php echo ($vo["country"]); ?>" name="country" style="width: 250px">
                        <br/>

                        <span class="p1">
                        上映时间:
                        <input class="attrs" value="<?php echo ($vo["time"]); ?>" name="time" style="width: 222px">
                        <br/>
                    </div>
                </div>
                </div></div>
        ...
        <div>
            <div id="brief">
                <textarea  name="brief" style="width: 80%;height: 100px">
